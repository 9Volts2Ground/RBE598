...
\begin{figure}[H]
    \centerline{\includegraphics[scale=0.8]{methods/figures/pi1.png}}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.12]{methods/figures/camera.png}
...
\begin{figure}[h]
    \centerline{\includegraphics[scale=0.12]{methods/figures/hc_sr04.png}}
